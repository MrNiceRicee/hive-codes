    ...
    <main className="flex h-[100dvh] w-screen items-center justify-center overflow-hidden bg-gradient-1 before:grainy before:opacity-40">
      <header className="flex w-full flex-col items-center overflow-hidden py-10 text-center before:crt before:animate-crt">
        ...
        <h1 className="ml-[-1.25cqw] animate-text-glitch font-cal text-7xl font-bold tracking-tighter mix-blend-hard-light sm:text-[22cqw]">
          <span className="inline-block duration-500 ease-spring-3 motion-safe:animate-in fade-in-0 slide-in-from-bottom-2">
            Hive Codes
          </span>
        </h1>
        <p className="mt-[-0.5cqw] text-xl font-light tracking-wide duration-500 ease-spring-3 motion-safe:animate-in fade-in-0 slide-in-from-top-3 sm:mt-[-1.5cqw] sm:text-[3.5cqw]">
        ...
        <section className="mt-[3cqw] origin-top duration-500 motion-safe:animate-in fade-in-0 zoom-in-50">
          <Link
            href="/search"
